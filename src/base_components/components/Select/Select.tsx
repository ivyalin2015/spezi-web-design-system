...
export const SelectItem = forwardRef<
  ...
  ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & { itemText?: string }
>(({ className, children, itemText, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    {...props}
  >
    <span className="absolute left-2 top-0 flex h-full w-3.5 items-center justify-center">
